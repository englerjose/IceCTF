...
public class TransportMediator extends TransportController {
    ...
    class C01521 implements TransportMediatorCallback {
        C01521() {
        }
    ...
    static boolean isMediaKey(int keyCode) {
        switch (keyCode) {
            case C0142R.styleable.Theme_panelMenuListTheme /*79*/:
            case C0142R.styleable.Theme_colorControlActivated /*85*/:
            case C0142R.styleable.Theme_colorControlHighlight /*86*/:
            case C0142R.styleable.Theme_colorButtonNormal /*87*/:
            case C0142R.styleable.Theme_colorSwitchThumbNormal /*88*/:
            case C0142R.styleable.Theme_alertDialogStyle /*89*/:
            case C0142R.styleable.Theme_alertDialogButtonGroupStyle /*90*/:
            case C0142R.styleable.Theme_alertDialogCenterButtons /*91*/:
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01521();
