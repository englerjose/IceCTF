...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01621 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01621() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01621());
        }
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case DEFAULT_GUTTER_SIZE /*16*/:
                            ...
                            break;
                        case C0142R.styleable.Theme_homeAsUpIndicator /*48*/:
                            childTop = paddingTop;
                            paddingTop += child.getMeasuredHeight();
                            break;
                        case C0142R.styleable.Theme_listChoiceBackgroundIndicator /*80*/:
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0142R.styleable.Theme_actionBarWidgetTheme /*21*/:
                return arrowScroll(17);
            case C0142R.styleable.Theme_actionBarSize /*22*/:
                return arrowScroll(66);
            case C0142R.styleable.Theme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
