...
public class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class C01631 implements AccessibilityStateChangeListenerBridge {
            ...
            C01631(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
        ...
        public Object newAccessiblityStateChangeListener(AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new C01631(listener));
        }
