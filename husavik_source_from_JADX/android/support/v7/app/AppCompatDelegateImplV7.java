...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01682 implements OnApplyWindowInsetsListener {
        C01682() {
        }
    ...
    class C01693 implements OnFitSystemWindowsListener {
        C01693() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C01682());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C01693());
                }
    ...
    public boolean requestWindowFeature(int featureId) {
        switch (featureId) {
            ...
            case C0142R.styleable.Toolbar_titleTextAppearance /*9*/:
                ...
                return true;
            case C0142R.styleable.Toolbar_subtitleTextAppearance /*10*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case TransportMediator.FLAG_KEY_MEDIA_PLAY /*4*/:
                ...
                break;
            case C0142R.styleable.Theme_colorPrimaryDark /*82*/:
