...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C01842 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C01853 extends ViewPropertyAnimatorListenerAdapter {
        C01853() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C01842());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C01853());
        }
    }
