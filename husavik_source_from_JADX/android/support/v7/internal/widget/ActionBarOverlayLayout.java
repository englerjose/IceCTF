...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C01821 extends ViewPropertyAnimatorListenerAdapter {
        C01821() {
        }
    ...
    class C01832 extends ViewPropertyAnimatorListenerAdapter {
        C01832() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01821();
        this.mBottomAnimatorListener = new C01832();
