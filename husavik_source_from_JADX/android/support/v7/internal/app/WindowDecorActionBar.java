...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01713 implements ViewPropertyAnimatorUpdateListener {
        C01713() {
        }
    ...
    class C01791 extends ViewPropertyAnimatorListenerAdapter {
        C01791() {
        }
    ...
    class C01802 extends ViewPropertyAnimatorListenerAdapter {
        C01802() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C01791();
        this.mShowListener = new C01802();
        this.mUpdateListener = new C01713();
