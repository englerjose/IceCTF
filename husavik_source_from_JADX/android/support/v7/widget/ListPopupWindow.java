...
public class ListPopupWindow {
    ...
    class C01761 extends ForwardingListener {
        C01761(View x0) {
            super(x0);
        }
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0142R.styleable.Toolbar_navigationIcon /*19*/:
                        case C0142R.styleable.Toolbar_navigationContentDescription /*20*/:
                        case C0142R.styleable.Theme_actionBarDivider /*23*/:
                        case C0142R.styleable.Theme_textColorSearchUrl /*66*/:
                            return true;
                    }
